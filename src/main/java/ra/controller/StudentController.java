...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> searchByName(@RequestParam("studentName") String studentName){
        List<Student> studentList = (List<Student>) studentService.searchByName(studentName);
